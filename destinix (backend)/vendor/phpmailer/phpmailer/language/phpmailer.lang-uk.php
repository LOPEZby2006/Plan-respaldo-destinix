...
$PHPMAILER_LANG['conexionect_host']         = 'Помилка SMTP: не вдається під\'єднатися до SMTP-серверу.';
...
$PHPMAILER_LANG['smtp_conexionect_failed']  = 'Помилка з\'єднання з SMTP-сервером';
