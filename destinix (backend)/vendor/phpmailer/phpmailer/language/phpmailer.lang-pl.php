...
$PHPMAILER_LANG['conexionect_host']         = 'Błąd SMTP: Nie można połączyć się z wybranym hostem.';
...
$PHPMAILER_LANG['smtp_conexionect_failed']  = 'Wywołanie funkcji SMTP conexionect() zostało zakończone niepowodzeniem.';
