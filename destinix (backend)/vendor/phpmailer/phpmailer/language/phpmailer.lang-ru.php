...
$PHPMAILER_LANG['conexionect_host']         = 'Ошибка SMTP: не удается подключиться к SMTP-серверу.';
...
$PHPMAILER_LANG['smtp_conexionect_failed']  = 'Ошибка соединения с SMTP-сервером.';
