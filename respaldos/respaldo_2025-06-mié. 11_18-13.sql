...
INSERT INTO `estado` VALUES (0,'activo'),(2,'inactivo'),(3,'bloqueado'),(4,'pendiente');
...
INSERT INTO `seguridad` VALUES (11,'diego.lopezm0405@gmail.com','$2y$10$NF22J9AZGSW1rcGxjjiSMe0hR5NKJUL/zeDDwWnyhpVh0esEyeCwu','',1,NULL),(29,'diegoestebanlopezmelo8@gmail.com','$2y$10$U/aPKc6ltP8ny.clWczAZOsUUjOVzYMuJImFP0lvorfrHzPB4ZTh2',NULL,1,NULL),(50,'diegolopez@gmail.com','$2y$10$1spmUyEa4keK1pU/9LFPce8B79Gt4WZiPfPpmCL5BmQ3MpyYmeciO',NULL,1,NULL),(74,'destinix.sas@gmail.com','$2y$10$HdYPm/ggZn0lwbNGJMJy9.WCK/d2Ay/ebyLc4qQfmNsTHxeyHfe9G',NULL,1,NULL);
...
CREATE TABLE `soporte_pagos` (
  ...
  `imagen_soporte` varchar(50) NOT NULL,
  ...
  KEY `id_empresa` (`id_empresa`,`id_persona`),
  ...
  CONSTRAINT `soporte_pagos_ibfk_7` FOREIGN KEY (`id_empresa`) REFERENCES `empresa` (`id_empresa`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-06-11 18:13:10
