...
export const VerificarUsu = async (id) => {
    const response = await fetch(`http://localhost/destinix/verificar.php`, {
        method: "PUT",
    });
    return await response.json();
};
...
export const sendResetEmail = async (email) => {
    const response = await fetch("http://localhost/destinix/SendMail.php", {
        method: "POST",
...
export const resetPassword = async (token, newPassword) => {
    const response = await fetch("http://localhost/destinix/reset.php", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
            token,
