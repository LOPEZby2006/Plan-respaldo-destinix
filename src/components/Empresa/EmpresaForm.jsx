...
const EmpresaForm = () => {
  ...
  const fetchData = async () => {
    try {
      const [empRes, perRes, catRes] = await Promise.all([
        axios.get("https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/api/Empresa/EmpresaController.php"),
        axios.get("https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/api/Persona/PersonaController.php"),
        axios.get("https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/api/Categoria/CategoriaController.php"),
      ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editando) {
        ...
        await axios.put("https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/api/Empresa/EmpresaController.php", datos);
        alert("Empresa actualizada correctamente");
      } else {
        await axios.post("https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/api/Empresa/EmpresaController.php", datos);
  ...
  const handleEliminar = async (id) => {
    if (window.confirm("¿Estás seguro de eliminar esta empresa?")) {
      try {
        await axios.delete(`https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/api/Empresa/EmpresaController.php?id=${id}`);
        fetchData();
      } catch (error) {
