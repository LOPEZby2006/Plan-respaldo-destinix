...
const ReservaForm = () => {
  ...
  const fetchReservas = async () => {
    try {
      const res = await axios.get("https://ambitious-forest-0ecbd371e.6.azurestaticapps.net/destinix/api/Reserva/ReservaController.php");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editando) {
        await axios.post("https://ambitious-forest-0ecbd371e.6.azurestaticapps.net/destinix/api/Reserva/ReservaController.php?editar=1", {
          ...form,
          id_reserva: idReserva
        });
        alert("Reserva actualizada");
      } else {
        await axios.post("https://ambitious-forest-0ecbd371e.6.azurestaticapps.net/destinix/api/Reserva/ReservaController.php", form);
  ...
  const handleEliminar = async (id) => {
    if (window.confirm("¿Deseas eliminar esta reserva?")) {
      try {
        await axios.delete(`https://ambitious-forest-0ecbd371e.6.azurestaticapps.net/destinix/api/Reserva/ReservaController.php?id=${id}`);
        fetchReservas();
      } catch (error) {
