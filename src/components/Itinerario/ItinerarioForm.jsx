...
const ItinerarioForm = () => {
  ...
  const fetchItinerarios = async () => {
    try {
      const res = await axios.get("http://ambitious-forest-0ecbd371e.6.azurestaticapps.net/destinix/api/Itinerario/ItinerarioController.php");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editando) {
        ...
        await axios.post("http://ambitious-forest-0ecbd371e.6.azurestaticapps.net/destinix/api/Itinerario/ItinerarioController.php?editar=1", formData);
        alert("Itinerario actualizado correctamente");
      } else {
        await axios.post("http://ambitious-forest-0ecbd371e.6.azurestaticapps.net/destinix/api/Itinerario/ItinerarioController.php", formData);
  ...
  const handleEliminar = async (id) => {
    if (window.confirm("¿Deseas eliminar este itinerario?")) {
      try {
        await axios.delete(`http://ambitious-forest-0ecbd371e.6.azurestaticapps.net/destinix/api/Itinerario/ItinerarioController.php?id=${id}`);
        fetchItinerarios();
      } catch (error) {
