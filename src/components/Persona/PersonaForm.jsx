...
const PersonaForm = () => {
  ...
  const fetchPersonas = async () => {
    try {
      const res = await axios.get("https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/api/Persona/PersonaController.php");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editando) {
        ...
        await axios.post("https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/api/Persona/PersonaController.php?editar=1", formData);
        alert("Persona actualizada");
      } else {
        await axios.post("https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/api/Persona/PersonaController.php", formData);
  ...
  const handleEliminar = async (id) => {
    if (window.confirm("¿Deseas eliminar esta persona?")) {
      try {
        await axios.delete(`https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/api/Persona/PersonaController.php?id=${id}`);
        fetchPersonas();
      } catch (error) {
