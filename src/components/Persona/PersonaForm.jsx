...
const PersonaForm = () => {
  ...
  const fetchPersonas = async () => {
    try {
      const res = await axios.get("https://ambitious-forest-0ecbd371e.6.azurestaticapps.net/destinix/api/Persona/PersonaController.php");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editando) {
        ...
        await axios.post("https://ambitious-forest-0ecbd371e.6.azurestaticapps.net/destinix/api/Persona/PersonaController.php?editar=1", formData);
        alert("Persona actualizada");
      } else {
        await axios.post("https://ambitious-forest-0ecbd371e.6.azurestaticapps.net/destinix/api/Persona/PersonaController.php", formData);
  ...
  const handleEliminar = async (id) => {
    if (window.confirm("¿Deseas eliminar esta persona?")) {
      try {
        await axios.delete(`https://ambitious-forest-0ecbd371e.6.azurestaticapps.net/destinix/api/Persona/PersonaController.php?id=${id}`);
        fetchPersonas();
      } catch (error) {
