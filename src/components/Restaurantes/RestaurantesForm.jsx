...
const RestaurantesForm = () => {
  ...
  useEffect(() => {
    axios.get("https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/obtener_empresa.php")
      .then(res => setEmpresas(res.data))
      .catch(err => console.error("Error al obtener empresas:", err));

    axios.get("https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/obtener_estado.php")
  ...
  const obtenerRestaurantes = () => {
    axios.get("https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/api/Restaurantes/RestaurantesController.php")
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editando) {
        ...
        await axios.post("https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/api/Restaurantes/RestaurantesController.php?editar=1", formData);
        alert("Restaurante actualizado correctamente");
      } else {
        await axios.post("https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/api/Restaurantes/RestaurantesController.php", formData);
  ...
  const handleEliminar = async (id) => {
    if (window.confirm("¿Estás seguro de eliminar este restaurante?")) {
      try {
        await axios.delete(`https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/api/Restaurantes/RestaurantesController.php?id=${id}`);
        obtenerRestaurantes();
      } catch (error) {
                ...
                restaurantes.map((restaurante) => (
                  <tr key={restaurante.id_restaurante}>
                    ...
                    <td>
                      {restaurante.img ? (
                        <img
                          src={`https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/api/uploads/${restaurante.img}`}
                          alt="Restaurante"
                          width="80"
                          height="60"
