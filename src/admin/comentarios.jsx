...
const Comentarios = ({ idHoteles }) => {
    ...
    useEffect(() => {
        fetch(`http://ambitious-forest-0ecbd371e.6.azurestaticapps.net/destinix/comentariosadmin.php?id_hoteles=${idHoteles}`, {
            credentials: 'include',
        })
            .then(res => res.json())
            .then(data => {
    ...
    const agregarComentario = () => {
        ...
        fetch('http://ambitious-forest-0ecbd371e.6.azurestaticapps.net/destinix/comentariosadmin.php', {
            method: 'POST',
            credentials: 'include',
            ...
            .then(data => {
                if (data.success) {
                    ...
                    return fetch(`http://ambitious-forest-0ecbd371e.6.azurestaticapps.net/destinix/comentariosadmin.php?id_hoteles=${idHoteles}`, {
                        credentials: 'include',
                    });
                } else {
