...
if ($method === "POST") {
    ...
    try {
        ...
        echo json_encode([
            "success" => true,
            "foto_perfil" => $foto_perfil ? "https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/imagenes/$foto_perfil" : null,
            "imagen_soporte" => $imagen_soporte ? "https://destinixweb-h7cxddbtb0duddbv.brazilsouth-01.azurewebsites.net/destinix/imagenes/$imagen_soporte" : null
        ]);
    } catch (Exception $e) {
        $conexion->rollback();
